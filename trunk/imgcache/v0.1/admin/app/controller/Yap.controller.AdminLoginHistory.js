 ...
 * 管理员登陆历史控制器
 *
 * @file            app/controller/Yap.controller.AdminLoginHistory.js
 * @version         0.1
...
Ext.define('Yap.controller.AdminLoginHistory', {
    ...
    store: function(data) {
        ...
        if (!this._store) {//未创建
            ...
            this._store = Ext.create('Yap.store.AdminLoginHistory');
        }
    ...
    tbar: function(data) {
        ...
        return {
                ...
                lang('TO'), extField.dateField({itemId: 'date_end'}), '-',
            {
                ...
                value: data.column,
                editable: false
            }, Yap.Field.combo().matchMode(), '-', //匹配模式 by mrmsl on 2012-07-28 17:58:59
    ...
    //放到最后定义，否则，jsduck后，上面的方法将属于Yap.store.Login或Yap.model.Login
    /**
    ...
    defineModel: function() {
         ...
         * 系统登陆数据模型
         */
        Ext.define('Yap.model.AdminLoginHistory', {
     ...
     * @member Yap.controller.Login
     */
    defineStore: function() {
        /**
         * 系统登陆数据容器
         */
        Ext.define('Yap.store.AdminLoginHistory', {
             ...
             * 模型
             */
            model: 'Yap.model.AdminLoginHistory',
            /**
             * @cfg {Object}
             * proxy
             */
...
//放到最后，以符合生成jsduck类说明
Ext.data.JsonP.Yap_controller_AdminLoginHistory(Yap.controller.AdminLoginHistory);