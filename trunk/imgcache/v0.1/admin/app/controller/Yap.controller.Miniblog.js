 ...
 * 微博控制器
 *
 * @file            app/controller/Yap.controller.Miniblog.js
 * @version         0.1
...
Ext.define('Yap.controller.Miniblog', {
    ...
    store: function(data) {
        ...
        if (!this._store) {//未创建
            ...
            this._store = Ext.create('Yap.store.Miniblog');
        }
    ...
    //放到最后定义，否则，jsduck后，上面的方法将属于Yap.store.Miniblog或Yap.model.Miniblog
    /**
     ...
     * @member Yap.controller.Miniblog
     */
    defineStore: function() {
        /**
         * 微博数据容器
         */
        Ext.define('Yap.store.Miniblog', {
...
//放到最后，以符合生成jsduck类说明
Ext.data.JsonP.Yap_controller_Miniblog(Yap.controller.Miniblog);