 ...
 * 应用程序
 *
 * @file            app/util/Yap.Application.js
 * @version         0.1
...
Ext.define('Yap.Application', {
     ...
     * 控制器
     */
    controllers: ['Yap.controller.Tree', 'Yap.controller.Tabs', 'Yap.controller.Index'],
    /**
     * @cfg {String}
     * 应用名称
     */
    ...
    launch: function() {
        Yap.App = this;
        var viewport = Ext.create('Yap.view.Viewport');//创建视图
        ...
        viewport.on('resize', Ext.bind(Yap.cmp.tabs.resizeTabs, Yap.cmp.tabs, [null, true]));
        Yap.History.init();//初始化浏览器导航
