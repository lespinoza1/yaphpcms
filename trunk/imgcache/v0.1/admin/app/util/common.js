    ...
    if (action.result) {//200
        ...
        switch (status) {
            ...
            case 401://未登陆
                ...
                global('app_login_win', global('app_login_win') || Ext.create('Yap.controller.Login').win());
                break;
...
function getController(controller) {
    ...
    try {
        return Yap.App.getController('Yap.controller.' + controller);
    }
    catch (e) {
