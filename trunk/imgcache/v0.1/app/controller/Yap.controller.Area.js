 ...
 * 国家地区控制器
 *
 * @file            app/controller/Yap.controller.Area.js
 * @version         0.1
...
Ext.define('Yap.controller.Area', {
    ...
    formField: function(data) {
        ...
        return [
            ...
            {//所属地区
                ...
                nodeField: '_node',
                store: Ext.create('Yap.store.Area', {
    ...
    store: function(data) {
        ...
        if (!this._store) {//未创建
            this._store = Ext.create('Yap.store.Area', {
                url: url
            });
...
//放到最后，以符合生成jsduck类说明
Ext.data.JsonP.Yap_controller_Area(Yap.controller.Area);