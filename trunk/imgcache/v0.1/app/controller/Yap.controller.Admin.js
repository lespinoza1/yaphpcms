 ...
 * 管理员控制器
 *
 * @file            app/controller/Yap.controller.Admin.js
 * @version         0.1
...
Ext.define('Yap.controller.Admin', {
    ...
    changePasswordAction: function(data) {
        ...
        if (!this._editForm) {
            this._editForm = Ext.create('Yap.ux.Form', {
        ...
        Yap.cmp.card.layout.setActiveItem(this._editForm);
...
//放到最后，以符合生成jsduck类说明
Ext.data.JsonP.Yap_controller_Admin(Yap.controller.Admin);