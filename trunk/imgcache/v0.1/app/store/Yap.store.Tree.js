 ...
 * 菜单数据容器
 *
 * @file            app/store/Yap.store.Tree.js
 * @version         0.1
...
Ext.define('Yap.store.Tree', {
    ...
    listeners: {
        load: function() {//加载完成后，菜单树可用
            !Yap.History.treeLoaded && Yap.History.notifyTreeLoaded();
        }
    },
    /**
     * @cfg {Object/String}
