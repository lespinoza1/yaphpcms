...
class AreaModel extends BaseModel {
    ...
    protected $_db_fields = array (
        ...
        //地区名称
        'area_name'        => array('validate' => array('_checkAreaName#PLEASE_ENTER,MODULE_NAME_AREA,NAME#data', '_checkLength#MODULE_NAME_AREA,NAME#value|0|50')),
    ...
    protected function _checkAreaName($name, $data) {
        ...
        if ($info) {
            return L('MODULE_NAME_AREA,EXIST') . ': <br /><span style="color: #666;font-weight: bold;">' . $this->_module->nav($info[$this->_pk_field], 'area_name') . '</span>';
        }
