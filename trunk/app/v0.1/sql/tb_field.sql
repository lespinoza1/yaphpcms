...
INSERT INTO `tb_field` VALUES (20,43,'img图片url地址','extField.textField(\'@input_name\', \'PLEASE_ENTER,%@field_name\', \'%@fieldLabel\', \'@value\', {size: 40})','url\n#{%PLEASE_ENTER,CORRECT,FORMAT,CN_DE,@field_name}#MUST_VALIDATE#notblank','','sys_base_img_url','http://v2.imgcache.extjs.mrmsl.com/images/',1,20,'',1);
