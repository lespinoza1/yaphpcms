...
INSERT INTO `tb_field` VALUES (16,43,'imgcache common url地址','extField.textField(\'@input_name\', \'PLEASE_ENTER,%@field_name\', \'%@fieldLabel\', \'@value\', {size: 40})','url\n#{%PLEASE_ENTER,CORRECT,FORMAT,CN_DE,@field_name}#MUST_VALIDATE#notblank','','sys_base_common_imgcache','http://imgcache.yaphpcms.com/v0.1/yablog/js/',1,15,'',1);
