...
) ENGINE=InnoDB AUTO_INCREMENT=77 DEFAULT CHARSET=gbk COMMENT='表单域表 by mashanling on 2012-12-27 11:37:21';
...
INSERT INTO `tb_field` VALUES (8,43,'网站根目录','extField.textField(\'@input_name\', \'PLEASE_ENTER,%@field_name\', \'%@fieldLabel\', \'@value\')','string\nnotblank','','sys_base_wwwroot','v0.1/',1,2,'',0);
...
INSERT INTO `tb_field` VALUES (16,43,'js脚本url地址','extField.textField(\'@input_name\', \'PLEASE_ENTER,%@field_name\', \'%@fieldLabel\', \'@value\', {size: 40})','url\n#{%PLEASE_ENTER,CORRECT,FORMAT,CN_DE,@field_name}#MUST_VALIDATE#notblank','','sys_base_js_url','http://imgcache.yaphpcms.com/v0.1/yablog/js/',1,16,'',1);
INSERT INTO `tb_field` VALUES (17,43,'css样式地址','extField.textField(\'@input_name\', \'PLEASE_ENTER,%@field_name\', \'%@fieldLabel\', \'@value\', {size: 40})','url\n#{%PLEASE_ENTER,CORRECT,FORMAT,CN_DE,@field_name}#MUST_VALIDATE#notblank','','sys_base_css_url','http://imgcache.yaphpcms.com/v0.1/yablog/css/',1,17,'',1);
...
INSERT INTO `tb_field` VALUES (20,43,'img图片url地址','extField.textField(\'@input_name\', \'PLEASE_ENTER,%@field_name\', \'%@fieldLabel\', \'@value\', {size: 40})','url\n#{%PLEASE_ENTER,CORRECT,FORMAT,CN_DE,@field_name}#MUST_VALIDATE#notblank','','sys_base_img_url','http://imgcache.yaphpcms.com/v0.1/yablog/images',1,20,'',1);
...
INSERT INTO `tb_field` VALUES (77,43,'imgcache common地址','extField.textField(\'@input_name\', \'PLEASE_ENTER,%@field_name\', \'%@fieldLabel\', \'@value\', {size: 40})','url\n#{%PLEASE_ENTER,CORRECT,FORMAT,CN_DE,@field_name}#MUST_VALIDATE#notblank','','sys_base_common_imgcache','http://imgcache.yaphpcms.com/common/',1,15,'',1);
INSERT INTO `tb_field` VALUES (78,43,'后台imgcache地址','extField.textField(\'@input_name\', \'PLEASE_ENTER,%@field_name\', \'%@fieldLabel\', \'@value\', {size: 40})','url\n#{%PLEASE_ENTER,CORRECT,FORMAT,CN_DE,@field_name}#MUST_VALIDATE#notblank','','sys_base_admin_imgcache','http://imgcache.yaphpcms.com/v0.1/admin/',1,15,'',1);
INSERT INTO `tb_field` VALUES (79,43,'后台管理入口','extField.textField(\'@input_name\', \'PLEASE_ENTER,%@field_name\', \'%@fieldLabel\', \'@value\')','string\nnotblank','','sys_base_admin_entry','admin.php',1,2,'',0);
