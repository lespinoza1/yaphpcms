 ...
 * 模板编译类
 *
 * @file            Misc_YapTemplate.class.php
 * @package         Yap
 * @version         0.1
 ...
 * @lastmodify      $Date: 2013-04-06 17:12:52 +0800 (周六, 06 四月 2013) $ $Author: msl-138@163.com $
 */
class Misc_YapTemplate {
    /**
    ...
    static public function getInstance($config = null) {
        ...
        if (!isset(self::$_instance[$identify])) {
            self::$_instance[$identify] = new Misc_YapTemplate($config);
        }
