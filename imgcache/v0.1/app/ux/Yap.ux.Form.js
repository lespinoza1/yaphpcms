...
Ext.define('Yap.ux.Form', {
    ...
    onSuccess: function(form, action) {
        ...
        var back = _GET('back');
        Yap.History.push(back ? decodeURIComponent(back) : this.controller.getAction(this.backControllerName, this.backActionName));
