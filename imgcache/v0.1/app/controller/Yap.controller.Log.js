 ...
 * 系统日志控制器
 *
 * @file            app/controller/Yap.controller.Log.js
 * @version         0.1
...
Ext.define('Yap.controller.Log', {
    ...
    store: function(data) {
        ...
        if (!this._store) {//未创建
            ...
            this._store = Ext.create('Yap.store.Log');
        }
    ...
    //放到最后定义，否则，jsduck后，上面的方法将属于Yap.store.Log或Yap.model.Log
    /**
     ...
     * @member Yap.controller.Log
     */
    defineStore: function() {
        /**
         * 系统日志数据容器
         */
        Ext.define('Yap.store.Log', {
...
//放到最后，以符合生成jsduck类说明
Ext.data.JsonP.Yap_controller_Log(Yap.controller.Log);