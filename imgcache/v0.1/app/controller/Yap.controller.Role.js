 ...
 * 模块设置控制器
 *
 * @file            app/controller/Yap.controller.Role.js
 * @version         0.1
...
Ext.define('Yap.controller.Role', {
   ...
   /**
    ...
    store: function() {
        ...
        if (!this._store) {//未创建
            this._store = Ext.create('Yap.store.Role', {
                autoLoad: true
            });
        }
...
//放到最后，以符合生成jsduck类说明
Ext.data.JsonP.Yap_controller_Role(Yap.controller.Role);