...
class BootstrapPlugin extends Yaf_Plugin_Abstract {
    ...
    private function _initLangTheme() {
        ...
        is_file($v = YAP_PATH . 'Languages/' . LANG . '.php') && L(include($v));//yap语言包
        ...
        !defined('FRONT_THEME_PATH') && define('FRONT_THEME_PATH', str_replace('modules/admin/', 'modules/' . YABLOG_FRONT_MODULE_NAME . '/', THEME_PATH));
    }//end _initLangTheme
    ...
    public function routerShutdown(Yaf_Request_Abstract $request, Yaf_Response_Abstract $response) {
        ...
        define('MODULE_NAME'            , CONTROLLER_NAME);                 //模块 = 控制器
