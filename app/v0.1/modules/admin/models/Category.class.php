...
class CategoryModel extends CommonModel {
    ...
    protected $_db_fields = array (
        ...
        //分类名称
        'cate_name'        => array('validate' => array('_checkCateName#PLEASE_ENTER,MODULE_NAME_CATEGORY,NAME#data', '_checkLength#MODULE_NAME_CATEGORY,NAME#value|0|30')),
    ...
    protected function _checkCateName($cate_name, $data) {
        ...
        foreach ($caches as $id => $item) {
            ...
            if (strtolower($item['cate_name']) == $cate_name && $cate_id != $id) {
                return L('MODULE_NAME_CATEGORY,NAME,EXIST');
            }
        }
